...
Review.create(content: "Super good", rating: 4, movie: star_wars)
Review.create(content: "no consistency with the plot", rating: 2, movie: star_wars)
Review.create(content: "It was good but shouldnt have killed Tony", rating: 5, movie: avengers)
Review.create(content: "Drag movie", rating: 3, movie: kgf)